...
public class MngLoginController {
	...
	@RequestMapping(value="/manager/company/findidform" ,method=RequestMethod.GET)
	public String findidform() {
		logger.info("findidform");
		return "manager/login/findId_form";
	}//findidform
	
	@RequestMapping(value="/manager/company/findidphone" ,method=RequestMethod.POST)
	...
	@RequestMapping(value="/manager/company/findidemail" ,method=RequestMethod.POST)
	...
	@RequestMapping(value="/manager/company/findpwdform" ,method=RequestMethod.GET)
	public String findpwdform() {
		logger.info("findpwdform");
		return "manager/login/findPwd_form";
	}//findpwdform
	
	@RequestMapping(value="/manager/company/findpwdphone" ,method=RequestMethod.POST)
	...
	@RequestMapping(value="/manager/company/findpwdemail" ,method=RequestMethod.POST)
