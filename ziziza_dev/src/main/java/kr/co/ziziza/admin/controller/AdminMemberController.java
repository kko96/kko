...
@Controller
@RequestMapping(value = "/admin/member/*", produces = "application/json;charset=UTF-8")
public class AdminMemberController {
	...
	public @ResponseBody String regist(AdminMemberVO vo) {
		int success = service.insertInfo(vo);
		if(success > 0) success = vo.getMemberNo();
	...
	public @ResponseBody String modify(AdminMemberVO vo) {
