        ...
        <nav class="navbar navbar-inverse" role="banner">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/main"><img src="${pageContext.request.contextPath}/resources/corlate/images/logo.png" alt="logo"></a>
                </div>
         ...
         <div class="container">
          ...
          <div class="row">
             <div class="form-group col-md-4 offset-md-6" style="width: 30%; float:none; margin:0 auto">
                <button type="submit" name="login-submit" class="form-control btn-danger">아이디/비밀번호 찾기</button>
             </div>
          </div>
          <div class="row">
             <div class="form-group col-md-4 offset-md-6" style="width: 30%; float:none; margin:0 auto">
                <button type="submit" name="login-submit" class="form-control btn-success">회원가입</button>
             </div>
          </div>
       </div>
    </section>
