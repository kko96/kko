...
$(function() {
	$("#btn_update").click(function() {
		...
		form.append('board_no',$("#hidTit").val());
		form.append('board_no',$("#hidMbrNo").val());
		form.append('board_no',$("#hidContents").val());
		$.ajax({
			  type:'POST'
			, url:"/board/update"
			, data:form
...
<div class="container">
	<div class="row contact-wrap"> 
                ...
                <form id="contact-form" class="contact-form" name="contact-form" method="post" action="sendemail.php" >
                        ...
                        <div class="form-group">
                            <label>작성자</label>
                            <input type="text" id="writer" name="writer" class="form-control" required="required" value="${detailVO.member_no}">
                        </div>
                        <div class="form-group">
                            <label>내용</label>
