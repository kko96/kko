...
<body>
<input type="hidden" id="hidNoCom" value="${detailVO.companyNo}" />
<input type="hidden" id="hidNoMng" value="${loginUser.mngNo}" />
    <header id="header">
    	...
    	<div class="container">
    		<div class="large-title text-center">
		    	...
		    	<div class="row">
		    		...
		    		<div class="form-group col-md-2">
		    			<input type="text" class="form-control" id="subject" value="${detailChargeVO.subject}">
		    		</div>
		    		<div class="form-group col-md-3">
		    			<input type="text" class="form-control" id="price" value="${detailChargeVO.price}">
		    		</div>
		  		...
		  		<div class="row">
		    		<div class="form-group col-md-8 col-md-offset-2">
		    			...
		    			<input type="text" id="address" class="form-control" name="address" value="${detailVO.address}">
		    		</div>	
		    	</div>
		    	<div class="row">	
		    		<div class="form-group col-md-8 col-md-offset-2">
		     			<label for="contents">소개</label>
		     			<input type="text" id="contents" class="form-control" name="contents" value="${detailVO.contents}">
		    		</div>
		    	</div>
		    	<div class="row">	
		    		<div class="form-group col-md-2 col-md-offset-2">
