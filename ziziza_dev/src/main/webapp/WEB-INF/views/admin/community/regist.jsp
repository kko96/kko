...
<div id="wrap" class="hideNav">
	...
	<div id="container">
		<div class="contentWrap">
			<div class="contents">
				<div class="title"><h3>커뮤니티 등록</h3></div>
				<div class="content">
					<form action='<c:url value="/admin/board/community/regist"/>' name="form" class="form" method="post" enctype="multipart/form-data">
						<fieldset class="box">
							<legend class="hide">커뮤니티 입력 폼</legend>
						...
						<fieldset class="fOpt">
							<a href='<c:url value="/admin/board/community/list"/>' class="lBtn btn">목록</a>
