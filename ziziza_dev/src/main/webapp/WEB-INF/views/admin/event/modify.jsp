			...
			<div class="contents">
				...
				<div class="content">
					<form action='<c:url value="/admin/board/event/modify"/>' name="form" class="form" data-no='<c:out value="${param.no}"/>' method="post" enctype="multipart/form-data">
						...
						<fieldset class="fOpt">
							<a href='<c:url value="/admin/board/event/delete"/>' class="dBtn btn">삭제</a>
							<a href='<c:url value="/admin/board/event/list"/>' class="lBtn btn">목록</a>
