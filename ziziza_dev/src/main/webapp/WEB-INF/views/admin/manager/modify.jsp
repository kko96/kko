				...
				<div class="content">
					<form action='<c:url value="/admin/manager/modify"/>' name="form" class="form" data-no='<c:out value="${param.no}"/>' method="post" enctype="multipart/form-data">
						<fieldset class="box">
							...
							<div>
								<label for="applyName">담당자</label><input type="text" name="applyName" id="applyName" disabled/>
							...
							<div>
								<label for="bizNo">사업자등록번호</label><input type="text" name="bizNo" id="bizNo" maxlength="12"/>
								<span class="message"></span>
							</div>
							<div>
						...
						<fieldset class="fOpt">
							<a href='<c:url value="/admin/manager/delete"/>' class="dBtn btn">삭제</a>
							<a href='<c:url value="/admin/manager/list"/>' class="lBtn btn">목록</a>
